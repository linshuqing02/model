...
class Base2_1_3(BaseModel):
    def __init__(
        ...
        smiles2cid_path = 'data/mimic3/SMILES2CID_1.pkl'
        smiles_3d_path = 'data/mimic3/smiles_3d_1'
    ...
    def forward(self, batch_data):
        ...
        # fusion
        # molecule_embeddings = torch.cat((embeddings_2D, embeddings_3D), 1)  #(195,256)
        # molecule_embeddings = molecule_embeddings.unsqueeze(0)
        # pool = torch.nn.AdaptiveAvgPool1d(128)
        # molecule_embeddings = pool(molecule_embeddings).squeeze(0)  #(195,128)
        ...
        drug_emb_list = torch.cat(drug_emb_list, dim=0)
